...
Components are named by **what they produce**. The flows that use them are named by **what the extractor receives** — see `README.md` for the three general flows and `workflow.md` for the direct circuits.
