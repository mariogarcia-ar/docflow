...
#: The repository root. This file lives at `scripts/poc-flow/flow/`, so the root
#: is three parents up.
...
#: Where the artifacts this library reads live (the sibling tree the task asked
#: for: `scripts/poc-flow/artifacts/`).
ARTIFACTS_ROOT: pathlib.Path = pathlib.Path(__file__).resolve().parents[1] / "artifacts"
