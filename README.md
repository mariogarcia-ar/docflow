...
| **1 — processors, independently** | ⏳ **in progress** — `pdf`: `PDF-01`, `PDF-02`, `PDF-04`, `PDF-05` done; `PDF-03`, `PDF-06`…`PDF-08` signatures only. `image`, `ocr`, `llm`: not started | `PDF-01`…`PDF-13`, `IMG-01`…`IMG-14`, `OCR-01`…`OCR-13`, `LLM-01`…`LLM-15` |
