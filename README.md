...
| **1 — processors, independently** | ⏳ **in progress** — `pdf`: `PDF-01`…`PDF-07` done; `PDF-08` signature only. `image`, `ocr`, `llm`: not started | `PDF-01`…`PDF-13`, `IMG-01`…`IMG-14`, `OCR-01`…`OCR-13`, `LLM-01`…`LLM-15` |
